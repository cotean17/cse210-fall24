...
class Program
{
    ...
    {
        Ref scriptureRef = new Ref("Proverbs", "3", "5-6");
        Scripture scripture = new Scripture(scriptureRef, "Trust in the lord with all thine heart and understanding; in all thy ways acknowledge him, and he shall direct thy paths.");
